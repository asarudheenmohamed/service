...
class CatalogProductFlat(models.Model):
    ...
    storecredit_to = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    storecredit_type = models.IntegerField(blank=True, null=True)
    storecredit_value = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
