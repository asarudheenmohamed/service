...
class CatalogProductFlat14(CatalogProductFlat):
    class Meta:
        managed = False
        db_table = 'catalog_product_flat_14'
        app_label = "magento"

class CatalogProductFlat15(CatalogProductFlat):
    class Meta:
        managed = False
...
class CatalogProductFlat26(CatalogProductFlat):
    class Meta:
        managed = False
