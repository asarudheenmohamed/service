...
class SalesFlatOrder(models.Model):
    ...
    base_customer_balance_amount = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    customer_balance_amount = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    base_customer_balance_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    customer_balance_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    base_customer_balance_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    customer_balance_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    bs_customer_bal_total_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    customer_bal_total_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    ...
    base_gift_cards_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gift_cards_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    base_gift_cards_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gift_cards_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    ...
    gw_base_price_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_price_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_items_base_price_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_items_price_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_card_base_price_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_card_price_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_base_tax_amount_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_tax_amount_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_items_base_tax_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_items_tax_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_card_base_tax_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_card_tax_invoiced = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_base_price_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_price_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_items_base_price_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_items_price_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_card_base_price_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_card_price_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_base_tax_amount_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_tax_amount_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_items_base_tax_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_items_tax_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_card_base_tax_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    gw_card_tax_refunded = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    ...
    rewardpoints_base_discount = models.DecimalField(max_digits=12, decimal_places=4)
    rewardpoints_discount = models.DecimalField(max_digits=12, decimal_places=4)
    rewardpoints_base_amount = models.DecimalField(max_digits=12, decimal_places=4)
    ...
    webpos_cash = models.DecimalField(max_digits=12, decimal_places=4)
    webpos_base_cash = models.DecimalField(max_digits=12, decimal_places=4)
    vtiger_id = models.IntegerField(blank=True, null=True)
    till_id = models.IntegerField()
    location_id = models.IntegerField()
    webpos_ccforpos = models.DecimalField(max_digits=12, decimal_places=4)
    webpos_base_ccforpos = models.DecimalField(max_digits=12, decimal_places=4)
    webpos_cp1forpos = models.DecimalField(max_digits=12, decimal_places=4)
    webpos_base_cp1forpos = models.DecimalField(max_digits=12, decimal_places=4)
    webpos_cp2forpos = models.DecimalField(max_digits=12, decimal_places=4)
    webpos_base_cp2forpos = models.DecimalField(max_digits=12, decimal_places=4)
    webpos_change = models.DecimalField(max_digits=12, decimal_places=4)
    webpos_base_change = models.DecimalField(max_digits=12, decimal_places=4)
    webpos_codforpos = models.DecimalField(max_digits=12, decimal_places=4)
    webpos_base_codforpos = models.DecimalField(max_digits=12, decimal_places=4)
    webpos_delivery_date = models.TextField(blank=True, null=True)
    ...
    customercredit_discount = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    base_customercredit_discount = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    base_customercredit_discount_for_shipping = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    customercredit_discount_for_shipping = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    base_customercredit_hidden_tax = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    customercredit_hidden_tax = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
...
class SalesFlatOrderItem(models.Model):
    ...
    order = models.ForeignKey(SalesFlatOrder, models.DO_NOTHING, related_name="items")
    ...
    customercredit_discount = models.DecimalField(max_digits=12, decimal_places=4)
    base_customercredit_discount = models.DecimalField(max_digits=12, decimal_places=4)
    base_customercredit_hidden_tax = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    customercredit_hidden_tax = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
